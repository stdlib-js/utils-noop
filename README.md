...
```javascript
noop = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-noop@v0.0.12-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-noop@v0.0.12-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/utils-noop/actions/workflows/test.yml/badge.svg?branch=v0.0.12
[test-url]: https://github.com/stdlib-js/utils-noop/actions/workflows/test.yml?query=branch:v0.0.12
