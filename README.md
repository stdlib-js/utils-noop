...
```javascript
noop = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-noop@umd/browser.js' )
```

Above will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the bundle tags (click [here](https://github.com/stdlib-js/utils-noop/tags) for a list of available tags). For example,

```javascript
noop = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-noop@v0.0.13-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var noop = require( 'path/to/vendor/umd/utils-noop/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/utils-noop/actions/workflows/test.yml/badge.svg?branch=v0.0.13
[test-url]: https://github.com/stdlib-js/utils-noop/actions/workflows/test.yml?query=branch:v0.0.13
